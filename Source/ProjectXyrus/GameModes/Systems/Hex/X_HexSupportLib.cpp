...
void UX_HexSupportLib::ConvertCoordinate_Cube_To_Oddq(const FX_HexCubeCoordinate& CubeCoordinate,
...
void UX_HexSupportLib::ConvertCoordinate_Oddq_To_Cube(const FX_HexOffsetCoordinate& OddqCoordinate,
